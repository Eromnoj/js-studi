...
function Notices() {
  ...
  <p>
    ...
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>{" "}
  ...
  <p>
    <strong>Propriétaire</strong> : Jonathan Moreschi – 8 rue de la Massane
    66700 Argeles sur Mer
    <br />
    <strong>Responsable publication</strong> : j.moreschi@outlook.fr –
    j.moreschi@outlook.fr
    <br />
    Le responsable publication est une personne physique ou une personne morale.
    <br />
    <strong>Webmaster</strong> : Jonathan Moreschi – j.moreschi@outlook.fr
    <br />
    <strong>Hébergeur</strong> : Netlify – netlify.com 94104 San Francisco
    fraud@netlify.com
    <br />
    <strong>Délégué à la protection des données</strong> : Jonathan Moreschi –
    j.moreschi@outlook.fr
    <br />
  </p>
  ...
  <p>
    ...
    susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs
    du site{" "}
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>{" "}
  ...
  <p>
    ...
    responsable. De la même façon, les mentions légales peuvent être modifiées à
  ...
  <p>
    ...
    a pour objet de fournir une information concernant l’ensemble des activités
    de la société.
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>{" "}
  ...
  <p>
    ...
    ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant
  ...
  <p>
    ...
    ne pourra être tenu responsable des dommages directs et indirects causés au
  ...
  <p>
    ...
    caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le
  ...
  <p>
    ...
    responsable du traitement des Données Personnelles est : Jonathan Moreschi.{" "}
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>
    est représenté par Jonathan Moreschi, son représentant légal
  </p>
  <p>
    ...
    appartient notamment au Client d’établir les finalités de ses traitements de
    données, de fournir à ses prospects et clients, à partir de la collecte de
    leurs consentements, une information complète sur le traitement de leurs
    données personnelles et de maintenir un registre des traitements conforme à
    la réalité. Chaque fois que{" "}
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>{" "}
  ...
  Jonathan Moreschi – DPO, Jonathan Moreschi <br />8 rue de la Massane 66700
  Argeles sur Mer.
  <p>
  ...
  <p>
    ...
    condition qu’il présentent les garanties suffisantes au regard des exigences
  ...
  <p>
    ...
    sécurité des Informations et notamment qu’elles ne soient pas communiquées à
    des personnes non autorisées. Cependant, si un incident impactant
    l’intégrité ou la confidentialité des Informations du Client est portée à la
    connaissance de{" "}
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>
  ...
  <p>
    ...
    perte, utilisation détournée, accès non autorisé, divulgation, altération ou
    destruction.
  </p>
  ...
  <p>
    ...
    compatibilité technique, le type de navigateur utilisé par le terminal, les
    paramètres de langue et d’affichage ou le pays depuis lequel le terminal
  ...
  <p>
    ...
    du fait du choix de l’Utilisateur. Pour la gestion des Cookies et des choix
    de l’Utilisateur, la configuration de chaque navigateur est différente. Elle
  ...
  <p>
    ...
    . À tout moment, l’Utilisateur peut néanmoins revenir sur son consentement à
    ce que{" "}
    <a href="https://fastidious-macaron-d5c0d2.netlify.app/">
      https://fastidious-macaron-d5c0d2.netlify.app/
    </a>{" "}
  ...
  <p>
    ...
    partenaire spécialiste d’analyses Web susceptible de se trouver (et donc de
    stocker les informations correspondantes, y compris l’adresse IP de
